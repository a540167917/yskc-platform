...
import com.ys.kc.sp.mapper.PmsRecordedRecordMapper;
 ...
 */
@Service
public class PmsRecordedRecordServiceImpl extends ServiceImpl<PmsRecordedRecordMapper, PmsRecordedRecord> implements PmsRecordedRecordService {
    @Resource
     ...
     */
    @Override
    public List selectPmsRecordedRecordList(String offsets, String pageSizes) {
     ...
     */
    @Override
    public List selectPmsRecordedRecordList(String account,String offsets, String pageSizes) {
