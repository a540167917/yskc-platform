...
import com.ys.kc.sp.mapper.PmsDemandRecordsMapper;
 ...
 */
@Service
public class PmsDemandRecordsServiceImpl extends ServiceImpl<PmsDemandRecordsMapper, PmsDemandRecords> implements PmsDemandRecordsService {
    @Resource
     ...
     */
    @Override
    public List selectPmsDemandRecordsList(String offsets, String pageSizes) {
     ...
     */
    @Override
    public List selectPmsDemandRecordsList(String account,String offsets, String pageSizes) {
